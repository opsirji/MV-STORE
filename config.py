...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mvstore")
DB_NAME = os.environ.get("DATABASE_NAME", "mongodb+srv://mvstore:mvstore@cluster0.00dl2o7.mongodb.net/?retryWrites=true&w=majority")
